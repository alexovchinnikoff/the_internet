...
def test_add_element_after_delete_one(page: Page):
    ...
    print(f"📄 Видна кнопка: {delete_element.inner_text()}")
    print("⏳ Ожидание 3 секунды...")

    # Можно добавить скриншот для наглядности
    page.screenshot(path="add_elm_after_delete_one_screenshot.png")
